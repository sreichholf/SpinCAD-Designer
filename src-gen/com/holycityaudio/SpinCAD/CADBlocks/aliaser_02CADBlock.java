 ...
 */ 
		...
		import com.holycityaudio.SpinCAD.SpinFXBlock;
 		import com.holycityaudio.SpinCAD.ControlPanel.aliaser_02ControlPanel;
		
		public class aliaser_02CADBlock extends SpinCADBlock {

			private static final long serialVersionUID = 1L;
			private aliaser_02ControlPanel cp = null;
			...
			public aliaser_02CADBlock(int x, int y) {
				super(x, y);
				setName("Aliaser");	
			...
			public void editBlock(){ 
				if(cp == null) {
					if(hasControlPanel == true) {
						cp = new aliaser_02ControlPanel(this);
					}
				}
			}
