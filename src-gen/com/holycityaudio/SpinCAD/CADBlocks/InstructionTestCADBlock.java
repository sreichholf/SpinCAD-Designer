 ...
 */ 
		...
		public class InstructionTestCADBlock extends SpinCADBlock {
			...
			sfxb.FXwriteDelay("buffer+", 50, -1.0);
			sfxb.FXwriteDelay("buffer^+", 25, 1.0);
			sfxb.FXwriteDelay("buffer^+", 250, 0.77);
			sfxb.FXwriteDelay("buffer^-", 75, 0.9);
			sfxb.FXwriteDelay("buffer#-", 350, 0.89);
			sfxb.FXwriteDelay("buffer#-", 35, 0.99);
			...
			sfxb.FXreadDelay("buffer+", 50, -1.0);
			sfxb.FXreadDelay("buffer^+", 25, 1.0);
			sfxb.FXreadDelay("buffer^+", 250, 0.77);
			sfxb.FXreadDelay("buffer^-", 75, 0.9);
			sfxb.FXreadDelay("buffer#-", 350, 0.89);
			sfxb.FXreadDelay("buffer#-", 35, 0.99);
