 ...
 */ 
		...
		public class gated_verbCADBlock extends SpinCADBlock {
			...
			sfxb.FXreadDelay("gdel+", 2340, 0.2);
			...
			sfxb.skip(ZRO, 2);
			sfxb.clear();
			sfxb.FXreadDelay("gdel+", 22937, 0.45);
			sfxb.FXreadDelay("gdel+", 21879, 0.5);
			sfxb.FXreadDelay("gdel+", 20502, 0.45);
			sfxb.FXreadDelay("gdel+", 19770, 0.4);
			sfxb.FXreadDelay("gdel+", 18723, 0.4);
			sfxb.FXreadDelay("gdel+", 18143, 0.5);
			sfxb.FXreadDelay("gdel+", 17134, 0.5);
			sfxb.FXreadDelay("gdel+", 15832, 0.55);
			sfxb.FXreadDelay("gdel+", 15045, 0.5);
			sfxb.FXreadDelay("gdel+", 13881, 0.5);
			sfxb.FXreadDelay("gdel+", 13056, 0.55);
			sfxb.FXreadDelay("gdel+", 12196, 0.6);
			sfxb.FXreadDelay("gdel+", 11397, 0.6);
			sfxb.FXreadDelay("gdel+", 10008, 0.6);
			sfxb.FXreadDelay("gdel+", 9023, 0.55);
			sfxb.FXreadDelay("gdel+", 7856, 0.4);
			sfxb.FXreadDelay("gdel+", 7087, 0.65);
			sfxb.FXreadDelay("gdel+", 6243, 0.6);
			sfxb.FXreadDelay("gdel+", 5194, 0.7);
			sfxb.FXreadDelay("gdel+", 4023, 0.6);
			sfxb.FXreadDelay("gdel+", 3101, 0.5);
			sfxb.FXreadDelay("gdel+", 1885, 0.7);
			sfxb.FXreadDelay("gdel+", 1156, 0.5);
